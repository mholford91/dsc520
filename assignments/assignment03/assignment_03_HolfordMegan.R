...
## `height` vs. `earn`
ggplot(heights_df, aes(x=height, y=earn)) + geom_point(color= "blue")
## `age` vs. `earn`
ggplot(heights_df, aes(x=age, y=earn)) + geom_point(color="red")
## `ed` vs. `earn`
ggplot(heights_df, aes(x=ed, y=earn)) + geom_point(color="green")

## Re-create the three scatterplots and add a regression trend line using
## the `geom_smooth()` function
## `height` vs. `earn`
ggplot(heights_df, aes(x=height, y=earn)) + geom_point(color= "blue") + geom_smooth()
## `age` vs. `earn`
ggplot(heights_df, aes(x=age, y=earn)) + geom_point(color="red") + geom_smooth()
## `ed` vs. `earn`
ggplot(heights_df, aes(x=ed, y=earn)) + geom_point(color="black") + geom_smooth()
